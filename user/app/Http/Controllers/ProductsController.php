...
class ProductsController extends Controller
{
   public function products(){
    ...
    $product_roles = $roles->checkrole("PRODUCT", $client->client_type);
    ...
    return view("products")->with("products", $products->toJson())->with("categories", $categories->toJson())->with("stocks",json_encode( $stocks))->with("client", $client)->with("fees", $fees)->with("sources", $sources)->with("product_roles", $product_roles)->with("command_roles", $command_roles);
   ...
   public function printproducts(){
    ...
    return view("printproducts")->with("products", $products->toJson());
   }
