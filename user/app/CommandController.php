...
class CommandController extends Controller
{
   ...
   $commands = Command::whereIn("id", $request->ids)->get();


     return view("print")->with("commands", $commands->toJson())->with("client", $client)->with("day", $day);
   ...
   public function commands(Request $request)
    ...
    $ref_date = validateDate("2020-11-10", 'Y-m-d');
      ...
      $client = Client::with("livreurs")->findOrFail($id);
