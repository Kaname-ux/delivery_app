...
<body>
  <div id="app">
       ...
       @if($product_roles->contains("action","D"))
    ...
    @endif
      @if($product_roles->contains("action","U"))
        <div class="modal fade " id="moovingModal" tabindex="-1" role="dialog">
            <div  class="modal-dialog" role="document">
                <div  class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
    ...
    <div id="appCapsule">
         ...
         <div class="row mb-2">
            <button v-on:click="addProduct" class="btn btn-primary" data-toggle="modal" data-target="#addProduct">+ Nouveau produit</button>
             ...
             <div class="col float-right">
                 <button  class="btn btn-primary" data-toggle="modal" data-target="#categoryModal">Categories</button>
         ...
         @if($product_roles->contains("action","C"))
          <div   class="modal fade " id="addProduct"  tabindex="-1" role="dialog">
            <div  class="modal-dialog" role="document">
                <div  class="modal-content">
                    <div class="modal-header">
                      <h5 @click="addProduct" class="modal-title editModalTitle">Ajouter Produit</h5>
                    ...
                    <div   class="modal-body">
                        ...
                        <form method="post" action="createproduct" enctype="multipart/form-data">
                            @csrf
                           <div :hidden='firstStep != 1' class="firststep">
                              <div class="form-group">
                                <label>Nom du produit</label>
                                <input required name="name" v-model="prodName" value="article" autocomplete="off" placeholder="Saisir le nom du produit" class="form-control border " type="" >
                            </div>

                             <div class="form-group">
                                <label>Categorie</label>

                                <select name="category"  class="form-control " type="" v-model="prodCategory">
                            ...
                            <div class="form-group">
                                <label>Description</label>
                                <textarea maxlength="2000" name="description" v-model="prodDescription" class="form-control " rows="4" cols="4"></textarea>
                             ...
                             <div class="form-group">
                                ...
                                <input required name="price" value="5000" v-model="prodPrice" autocomplete="off" placeholder="Saisir le prix du produit" class="form-control " type="number" >
                                
                            </div>


                            <div class="form-group">
                                <label>Cout d'achat</label>
                                
                                <input required name="cost"  v-model="prodCost"  placeholder="Saisir le prix du produit" class="form-control" type="number" value="2000" >
                                
                            </div>
                          <div class="row float-right">
                            <button type="button" :disabled="prodName == ''  ||  prodPrice == '' || prodCost == ''" @click="step2()" class="btn btn-primary squared">Suivant</button>
                            </div>   
                           </div>
                           ...
                           <!-- Second step -->
                            ...
                            <div :hidden='secondStep != 1' class="secondstep">
                                <h4>Images</h4>
                                <div class="row mb-2">
                                <div class="col-6">
                                   
                                    <img width="70" height="70" id="blah" :src="img" alt="your image" />
                                     <input name="file" accept="image/*" class="form-control" type='file' @change="readURL" />
                                </div>

                                <div class="col-6">
                                   
                                    <img width="70" height="70" id="blah1" :src="img1" alt="your image" />
                                     <input name="file1" accept="image/*" type='file' @change="readURL1" />
                                </div>
                                </div>
                                <div class="row">
                                <div class="col-6">
                                   
                                    <img width="70" height="70" id="blah2" :src="img2" alt="your image" />
                                     <input name="file2" accept="image/*" type='file' @change="readURL2" />
                                </div>

                                <div class="col-6">
                                   
                                    <img  width="70" height="70" id="blah3" :src="img3" alt="your image" />
                                     <input name="file3" accept="image/*" type='file' @change="readURL3" />
                                </div>
                             ...
                             <div class="col float-left">
                                  <button type="button" @click="step1()" class="btn btn-primary squared">Precedent</button>
                             </div> 

                             <div class="col float-right">
                                  <button type="button"  @click="step3()" class="btn btn-primary squared">Suivant</button>
                             </div>       
                           ...
                           <!-- Third step -->
                           <div :hidden='thirdStep != 1'>
                             <h4>Variantes et stocks</h4>
                             <div hidden class="form-check">
                            <input checked v-model="novariant" class="form-check-input" type="checkbox" value="1" id="flexCheckDefault">
                        ...
                        Il n'y a pas de variante
                         ...
                         <div v-if="!novariant">
                            ...
                            <div  class="row">
                                ...
                                <div class="col">
                                    <label>Taille 1</label>
                                    <select name="size1" class="form-control">   <option value="">Indefini</option>
                                        <option v-for="size in sizes">
                                            @{{size}}
                                        </option>
                                        <option v-for="x in 200">
                                            @{{x}}
                                        </option>
                                    </select>
                                </div>
                                ...
                                <!-- <div class="col">
                                    ...
                                    <select name="color1" class="form-control">
                                        ...
                                        <option :value="color.name" v-for="color in colors">
                                            @{{color.name}}
                                        </option>
                                    </select>
                                </div> -->
                               <div class="col">
                                ...
                                <input :value="productStock" autocomplete="off" placeholder="Saisir le stock initial" class="form-control border border-primary" type="" name="stock1">
                            ...
                            <div  class="row">
                                ...
                                <div class="col">
                                    ...
                                    <select name="size2" class="form-control">   <option value="">Indefini</option>
                                        <option v-for="size in sizes">
                                            @{{size}}
                                        </option>
                                        <option v-for="x in 200">
                                ...
                                <!-- <div class="col">
                                    <label>Couleur</label>
                                    <select name="color2" class="form-control">  
                                        <option value="">Indefini</option>
                                        <option :value="color.name" v-for="color in colors">
                                            @{{color.name}}
                                        </option>
                               ...
                               <div class="col">
                                ...
                                <input :value="productStock" autocomplete="off" placeholder="Saisir le stock initial" class="form-control border border-primary" type="" name="stock2">
                            ...
                            <div  class="row">
                               ...
                               <!--  <div class="col">
                                    <label>Couleur</label>
                                    <select name="color3" class="form-control">
                                        <option value="">Indefini</option>
                                        <option :value="color.name" v-for="color in colors">
                                            @{{color.name}}
                                        </option>
                               ...
                               <div class="col">
                                ...
                                <input :value="productStock" autocomplete="off" placeholder="Saisir le stock initial" class="form-control border border-primary" type="" name="stock3">
                            ...
                            <div  class="row">
                                ...
                                <div class="col">
                                    <label>Taille 4</label>
                                    <select name="size4" class="form-control">   <option value="">Indefini</option>
                                        <option v-for="size in sizes">
                                            @{{size}}
                                        </option>
                                        <option v-for="x in 200">
                               ...
                               <!--  <div class="col">
                                    <label>Couleur</label>
                                    <select name="color4" class="form-control">
                                        <option value="">Indefini</option>
                                        <option :value="color.name" v-for="color in colors">
                                            @{{color.name}}
                                        </option>
                               ...
                               <div class="col">
                                ...
                                <input :value="productStock" autocomplete="off" placeholder="Saisir le stock initial" class="form-control border border-primary" type="" name="stock4">
                            ...
                            <div  class="row">
                                ...
                                <!-- <div class="col">
                                    <label>Couleur</label>
                                    <select name="color5" class="form-control">
                                        <option value="">Indefini</option>
                                        <option :value="color.name" v-for="color in colors">
                                            @{{color.name}}
                                        </option>
                               ...
                               <div class="col">
                                ...
                                <input :value="productStock" autocomplete="off" placeholder="Saisir le stock initial" class="form-control border border-primary" type="" name="stock5">
                        ...
                        <div  class="row">
                                ...
                                <div class="col">
                                    <label>Taille 6</label>
                                    <select name="size6" class="form-control">   
                                        <option value="">Indefini</option>
                                        <option v-for="size in sizes">
                                            @{{size}}
                                        </option>
                               ...
                               <div class="col">
                                ...
                                <input :value="productStock" autocomplete="off" placeholder="Saisir le stock initial" class="form-control border border-primary" type="" name="stock6">
                         ...
                         <div  class="row">
                                ...
                                <div class="col">
                                    <label>Taille 7</label>
                                    <select name="size7" class="form-control">   
                                        <option value="">Indefini</option>
                                        <option v-for="size in sizes">
                                            @{{size}}
                                        </option>
                               ...
                               <div class="col">
                                ...
                                <input :value="productStock" autocomplete="off" placeholder="Saisir le stock initial" class="form-control border border-primary" type="" name="stock7">
                            ...
                            <div class="row mt-2">
                             ...
                             <div class="col float-left">
                                  <button type="button" @click="step2()" class="btn btn-primary squared">Precedent</button>
                             </div> 

                             <div class="col float-right">
                                  <button :disabled="prodName == '' ||  prodDescription == '' || prodPrice == '' || prodCost == ''" type="submit"   class="btn btn-success squared">Enregistrer</button>
                             </div>       
      ...
      @if($product_roles->contains("action","U"))
          <div   class="modal fade " id="editProduct"  tabindex="-1" role="dialog">
            <div  class="modal-dialog" role="document">
                <div v-if="selectedVariant != null"  class="modal-content">
                    <div class="modal-header">
                      <h5  class="modal-title editModalTitle">Modifier Produit: @{{products[selectedVariant].name}}</h5>
                        <a href="javascript:;" data-dismiss="modal">Fermer</a>
                    ...
                    <div   class="modal-body">
                        ...
                        <form method="post" action="editproduct" enctype="multipart/form-data">
                            @csrf
                            <input hidden type="" name="id" :value="products[selectedVariant].id">
                           <div :hidden='firstStep != 1' class="firststep">
                              <div class="form-group">
                                <label>Nom du produit</label>
                                <input required name="name"  :value="products[selectedVariant].name" autocomplete="off" placeholder="Saisir le nom du produit" class="form-control border " type="" >
                            </div>

                             <div class="form-group">
                                <label>Categorie</label>

                                <select name="category"  class="form-control " type="" >
                                    <option value="">Choisir une categorie</option>
                                    
                                    <option :selected="products[selectedVariant].category == category.name" v-for="category in categories"  :value="category.name">@{{category.name}}</option>
                            ...
                            <div class="form-group">
                                <label>Description</label>
                                <textarea  maxlength="2000" name="description" v-model="prodDescription" class="form-control " rows="4" cols="4">@{{products[selectedVariant].description}}</textarea>
                             ...
                             <div class="form-group">
                                ...
                                <input required name="price" value="@{{products[selectedVariant].price}}"  autocomplete="off" placeholder="Saisir le prix du produit" class="form-control " type="number" >
                            ...
                            <div class="form-group">
                                ...
                                <input required name="cost"    placeholder="Saisir le prix du produit" class="form-control" type="number" :value="products[selectedVariant].cost" >
                           ...
                           <!-- Second step -->
                            ...
                            <div :hidden='secondStep != 1' class="secondstep">
                                ...
                                <div class="col-6">
                                    ...
                                    <img width="70" height="70" id="blah" :src="findImage(products[selectedVariant].photo)" alt="your image" />
                                     <input name="file" accept="image/*" class="form-control" type='file' @change="readURL" />
                                </div>

                                <div class="col-6">
                                   
                                    <img width="70" height="70" id="blah1" :src="img1" />
                                     <input name="file1" accept="image/*" type='file' @change="readURL1" />
                                </div>
                                </div>
                                <div class="row">
                         ...
                         <div hidden v-if="!novariant">
                            ...
                            <div  class="row">
                               ...
                               <div class="col">
                                ...
                                <input  autocomplete="off" placeholder="Saisir le stock initial" class="form-control border border-primary" type="" name="stock3">
                    ...
                    <div   class="modal-body">
                        <form method="post" enctype="multipart/form-data" :action="productAction" >
                            ...
                            <div class="form-group">
                                ...
                                <select   class="form-control border border-primary" type="" name="category">
                                    <option value="">Choisir une categorie</option>
      ...
      <div   class="modal fade " id="productDetail"  tabindex="-1" role="dialog">
        ...
        <div   class="modal fade " id="cmd"  tabindex="-1" role="dialog">
            ...
            <div v-if="newR" class="card-body">
               ...
               <button type="button" @click="shareBill('Commande'+ ' '+ newR.id+'. '+newR.description+ '. Total:'+ (Number(newR.montant)+Number(newR.livraison))+'. '+newR.adresse+ '. '+newR.phone+ '. Plus de detail sur https://{{  url('') }}/'+newR.id)" class="btn btn-primary btn-block mt-2 squared" id="bill">ENVOYER FACTURE</button>
           </div>
            </div>
       ...
       Aucum produit dans le panier
        ...
        <div class="section mt-2">
           ...
           <div class="transactions">
            @if($product_roles->contains("action","R"))
            ...
            <div v-for="(product, index) in products" :key="product.id" @mouseover="updateVariant(index)" class="col-md-6 target2">
                ...
                <a href="#" >
                    ...
                    @if($product_roles->contains("action","D"))
                    <button data-toggle="modal" data-target="#deleteProduct" v-on:click="deleteProduct" class="btn btn-danger btn-sm mr-1"><ion-icon name="trash-outline"></ion-icon></button>
                    @endif
                    @if($product_roles->contains("action","C"))
                    <button data-toggle="modal" data-target="#editProduct" v-on:click="editProduct" class="btn btn-primary btn-sm mr-1"><ion-icon name="pencil-outline"></ion-icon></button>
                    @endif
...
<script type="text/javascript">
    ...
    data() {
        return {
            ...
            colors: [
              { name: 'Orange', code: '#EB890C'},
              { name: 'Vert', code: '#4AA31A'},
              { name: 'Blanc', code: 'fff'},
              { name: 'Bleu', code: '#1A6DC6'},
              { name: 'Rouge', code: '#fff'},
              { name: 'Jaune', code: '#FBE105'},
              { name: 'Rose', code: '#F735D6'},
              { name: 'Violet', code: '#7107A5'},
              { name: 'Marron', code: '#500909'},
              { name: 'Noir', code: '#000'},
             ...
             newProd:null,
             img:'assets/img/sample/brand/1.jpg',
             img1:'assets/img/sample/brand/1.jpg',
             img2:'assets/img/sample/brand/1.jpg',
             img3:'assets/img/sample/brand/1.jpg'
...
cancelCmd(){
  ...
  .then(function (response) {
    ...
    vm.newProd = response.data.newProd
    vm.secondStep = 1
    vm.firstStep = null
  })
  .catch(function (error) {
    ...
    vm = this
    axios.post('/createproductthirdstep', {
