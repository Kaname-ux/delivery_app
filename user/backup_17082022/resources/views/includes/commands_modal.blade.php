...
<!-- Dialog with Image -->
    ...
    <span class="input-group-text" id="basic-addon1">Client</span>
      ...
      <input id="cmdcostumer" maxlength="150"  value="{{ old('costumer') }}"  name="costumer" class="form-control" type="text" placeholder="Nom du client" aria-label="Client" aria-describedby="basic-addon1" >
      </div>
     
      <div class="input-group mb-2">
       <div class="input-group-prepend">
    <span class="input-group-text" id="">Colis*</span>
  </div>
    ...
    <span class="input-group-text" id="">Tarif livraison*</span>
     ...
     <div class="input-group mb-2 autre" hidden>
       <div class="input-group-prepend">
...
@if($client->livreurs->count() > 0)
 <div class="input-group mb-3 livreurInput">
    ...
    <span class="input-group-text" id="">Livreur</span>
      ...
      <textarea id="comobservation" maxlength="150" value="{{ old('observation') }}"  name="observation" class="form-control" type="text" placeholder="Information supplementaire" rows="4" cols="4"></textarea>
      </div>
