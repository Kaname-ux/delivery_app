...
<body>
  <div id="app">
    ...
    <div id="appCapsule">
        ...
        <div class="col">
            <a  target="_blank" class="btn btn-sm btn-light phone" href="printproducts" ><ion-icon name="print-outline"></ion-icon>Imprimer catalogue</a>
        </div>
        
         </div>

         <div class="row border border-primary mt-2 mb-2">
