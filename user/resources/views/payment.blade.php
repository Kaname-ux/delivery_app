...
<div class="content">
        ...
        <div class="row">
          <div class="col-md-12">
           ...
           <button  class="btn btn-danger btn-sm delete_all" data-url="{{ url('bulk-pay') }}">Payer selection</button>
           <meta name="csrf-token" content="{{ csrf_token() }}" />
               <p>Il vous reste {{$payments->count()}} Payements en attente.</p>
                    ...
                    <tbody>
                      ...
                      <tr id="tr_{{$payment->id}}">
                        ...
                        <td>
                           ...
                           <button class="btn btn-default" data-toggle="modal" data-target="#myModal{{$payment->id}}" type="button">Payer</button>
                        ...
                        <td>
                          ...
                          <strong>Commande #{{$payment->command_id}}<br>{{$payment->montant}}<br>Livré le: {{$payment->command->delivery_date->format('d-m-Y')}}</strong>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="POST" action="pay-update/{{$payment->id}}">
          @csrf
          <div class="form-group">
          <select name="pay_methode" required class="form-control">
            <option>Choisir moyen de payement</option>
