...
<body>
 ...
 <form hidden action="?" class="range-form ">
       ...
       <div class="section  pt-1">
            ...
            <li>
                <div class="item">
                    ...
                    <div class="in">
                        ...
                        <span class="text-muted">{{$product["product_qty"]}}</span>
                    </div>
                </div>
            </li>
           @endforeach 
        ...
        <div class="section  pt-1">
          <div class="listview-title mt-2">Par Utilisateur {{$sales_by_salesman->count()}}</div>
        <ul class="listview image-listview">
          @foreach($sales_by_salesman as $salesman)
            <li>
                 <a href="/usersales?id={{$salesman->client->id}}">
                <div class="item">
                    <div class="icon-box bg-primary">
                        <ion-icon name=""></ion-icon>
                    </div>
                    <div class="in">
                        ...
                        <span class="text-muted">{{$salesman->montant}}</span>
                    </div>
                </div>
                </a>
            </li>
