  ...
  </div><input placeholder="Commencer à taper le nom"  @input="handleProvInput('providers')" id="provider"  v-model="providerName" 
      ...
      <textarea v-model="observation" id="comobservation" maxlength="150" value="{{ old('observation') }}"  name="observation" class="form-control" type="text" placeholder="Information supplementaire" rows="4" cols="4">
            ...
            <span v-if="cmdError" class="mb-2 alert alert-danger" >@{{cmdError}}</span>
                            ...
                            <div v-if="confirm">
                               ...
                               <button v-if="livraison =='autre'" type="button" @click="confirmCmd" :disabled="nature == '' || delivery_date == '' ||  destination == ''|| fee == '' || phone == '' || livraison == '' || provider == '' || provAdresse == '' || provPhone == '' || provName == '' || provCity == '' || livreur == ''"   class="btn btn-success  mr-2" 

                                        >Oui confirmer</button>



                               <button v-else type="button" @click="confirmCmd" :disabled="nature == '' || delivery_date == '' ||  destination == ''|| fee == '' || phone == '' || livraison == '' || provider == '' || provAdresse == '' || provPhone == '' || provName == '' || provCity == '' || livreur == ''"  class="btn btn-success  mr-2" 
                               ...
                               <button @click="cancelCmd" type="button"  class="btn btn-danger" >Non Annuler</button>         
                                ...
                                <div v-else  class="form-group basic">
                                    ...
                                    <button v-if="livraison =='autre'" type="button" @click="newCmd" :disabled="nature == '' || delivery_date == '' ||  destination == ''|| fee == '' || phone == '' || livraison == '' || provider == '' || provAdresse == '' || provPhone == '' || provName == '' || provCity == ''"   class="btn btn-primary btn-block btn-lg" id="addCmd"
