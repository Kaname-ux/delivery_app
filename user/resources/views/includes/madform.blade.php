<form id="cmdForm" onsubmit="return false;">
  ...
  </div><input placeholder="Commencer à taper le nom"  @input="handleProvInput('madproviders')" id="distrbprovider"  v-model="distribProviderName" 
...
<div class="card mb-1">
  ...
  <input v-model="maddecherge" value="1" class="form-check-input" type="checkbox" value="1" id="maddecharge">
...
@if($command_roles->contains('action', 'ASSIGN'))
 ...
 <div v-if="madLivreurs" class="input-group mb-3 livreurInput">
    ...
    <span class="input-group-text" id="">Livreur</span>
      ...
      <option v-for="liv in madLivreurs" :value="liv.id">@{{liv.nom}}</option>
      ...
      <textarea v-model="observation" id="comobservation" maxlength="150" value="{{ old('observation') }}"  name="observation" class="form-control" type="text" placeholder="Information supplementaire" rows="4" cols="4">
            ...
            <span v-if="cmdError" class="mb-2 alert alert-danger" >@{{cmdError}}</span>
                            ...
                            <div v-if="confirm">
                               ...
                               <button v-if="livraison =='autre'" type="button" @click="confirmCmd" :disabled="nature == '' || delivery_date == '' ||  destination == ''|| fee == '' || phone == '' || livraison == '' || provider == '' || provAdresse == '' || provPhone == '' || provName == '' || provCity == '' || livreur == '' || plis == '' || type == '' || delivType == '' || poids == ''"   class="btn btn-success  mr-2" 

                                        >Oui confirmer</button>



                               <button v-else type="button" @click="confirmCmd" :disabled="nature == '' || delivery_date == '' ||  destination == ''|| fee == '' || phone == '' || livraison == '' || provider == '' || provAdresse == '' || provPhone == '' || provName == '' || provCity == '' || livreur == '' || plis == '' || type == '' || delivType == '' || poids == ''"  class="btn btn-success  mr-2" 
                               ...
                               <button @click="cancelCmd" type="button"  class="btn btn-danger" >Non Annuler</button>         
                                ...
                                <div v-else  class="form-group basic">
                                    ...
                                    <button v-if="livraison =='autre'" type="button" @click="newCmd" :disabled="nature == '' || delivery_date == '' ||  destination == ''|| fee == '' || phone == ''  || provider == '' || provAdresse == '' || provPhone == '' || provName == '' || provCity == ''  || type == ''  || delivType == '' || poids == ''"   class="btn btn-primary btn-block btn-lg" id="addCmd"
           ...
           <button v-else type="button" @click="newCmd" :disabled="nature == '' || delivery_date == '' ||  destination == ''|| fee == '' || phone == ''  || provider == '' || provAdresse == '' || provPhone == '' || provName == '' || pro || vCity == ''  || type == '' || delivType == '' || poids == ''"   class="btn btn-primary btn-block btn-lg" id="addCmd" >Enregister
           </button>    
