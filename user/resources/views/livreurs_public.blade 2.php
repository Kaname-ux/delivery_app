                    ...
                    <h4>Detailler par lieu de livraison</h4>
                           <button id="addRow" type="button" class="btn btn-info mb-2">Ajoueter une Destination</button>
                             ...
                             <div id="newRow" class="mb-2"></div>
                                ...
                                <input type="button" name="previous" class="previous action-button-previous" value="Précédent"/>
                                <button type="submit" name="make_payment" class="next action-button" value="Confirmer">></button>
                            </fieldset>
                            <fieldset>
                                <div class="form-card">
...
$(".next").click(function(){
    ...
    current_fs = $(this).parent();
     ...
     if ( current_fs.hasClass( "colis" ) ) {
     ...
     else if ( current_fs.hasClass( "recup" ) ) {
      ...
      if($('.wa').val().length != 10 )
      {
        $('.delivedate_er').html("Veullez saisir un contact valide");
      }
