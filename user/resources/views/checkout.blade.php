    ...
    <div id="search" class="appHeader">
        <form class="search-form">
            <div class="form-group searchbox">
                <input onkeyup="search()" id="Search" name="text" type="text" class="form-control" placeholder="Recherche...">
...
<button data-toggle="modal" data-target="#checkoutModal" class="btn  btn-primary  ml-3"><ion-icon name="bicycle-outline"></ion-icon>{{$curlivreur->nom}}</button>
        ...
        <div class="section-full" style="margin-top: 80px;">
             ...
             @endif
              ...
              <button type="button" @if(date_create($by_date->delivery_date)->format("d-m-Y") == $day) class="btn btn-success text-bold"  @else class="btn btn-primary text-bold" @endif>{{ $by_date->montant }}F</button>
            <button type="button"@if(date_create($by_date->delivery_date)->format("d-m-Y") == $day) class="btn btn-outline-success text-bold"  @else class="btn btn-outline-primary text-bold" @endif>{{ date_create($by_date->delivery_date)->format("d-m-Y") }}</button>
                 </div>
           ...
           <div class="section-full mt-2" >
              ...
              <button type="button" @if(date_create($undone_by_date->delivery_date)->format("d-m-Y") == $day) class="btn btn-success text-bold"  @else class="btn btn-primary text-bold" @endif>{{ $undone_by_date->nbre }}</button>
            <button type="button" @if(date_create($undone_by_date->delivery_date)->format("d-m-Y") == $day) class="btn btn-outline-success text-bold"  @else class="btn btn-outline-primary text-bold" @endif>{{ date_create($undone_by_date->delivery_date)->format("d-m-Y") }}</button>
                 </div>
        ...
        <div class="section-full " >
            ...
            <div class="commands transactions">
                <div class="row"> 
