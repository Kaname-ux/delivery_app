                                ...
                                <div class="form-group basic">
                                    <div class="input-wrapper">
                                        <form  autocomplete="off"  action='?bydate' >
                                         ...
                                         <button type="submit" class="btn btn-outline-primary btn-block "   >Aujourd'hui</button>
                                        ...
                                        <form  autocomplete="off"  action='?bydate' >
                                         ...
                                         <button class="btn btn-outline-primary btn-block " type="submit"  >Demain</button>
            ...
            <div  class="modal-dialog" role="document">
                <div  class="modal-content">
                    ...
                    <div   class="modal-body">
                      ...
                      <button onclick="$('#cmdMenumodal').modal('hide');$('#editModal').modal('show');" class="edit btn btn-outline-primary btn-block">Modifier</button>
                     <button onclick="$('#cmdMenumodal').modal('hide');$('#duplicateModal').modal('show');" class="duplicate btn btn-outline-primary btn-block">Dupliquer</button>
                   ...
                   Ajouter à la liste enregitrement rapides</button>

                   <form style="margin-top: 5px; " id="cmdResetForm"  class="form-inline" action="/reset" method="POST">
                     @csrf
                   </form>

                   <form style="margin-top: 5px; " id="cmdCancelForm"  class="form-inline" action="/cancel" method="POST">
                     @csrf
                   </form>
                        </div>
                    </div>
...
<!-- toast center auto close in 2 seconds -->
   ...
   <!-- Dialog with Image -->
        <div class="modal fade dialogbox" id="InstaAppModal" data-backdrop="static" tabindex="-1" role="dialog">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="pt-3 text-center">
                        <img src="../assets/img/logo-icon.png" alt="image" class="imaged w48 rounded mb-1">
                    </div>
