...
<script src='../assets/js/star-rating.min.js'></script>
 ...
 $products = $products->toJson();
    ...
    return view("catalog")->with("products", $products)->with("stocks", json_encode($stocks))->with("client", $client)->with("fees", $fees)->with("title", $title)->with("cart", $cart)->with("total", $total);
