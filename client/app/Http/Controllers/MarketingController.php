  ...
  public function marketing(Request $request){
   ...
   if($ins->count() > 0)
    ...
    $smscount = $smsin-$smsout;
             ...
             if($client->has_global == "yes" && $client->global_end != null){
              if($client->global_end >= date('Y-m-d')){
...
99999999")->where("fee_id", "!=", null)->where("phone", "!=", "0000000")->where("phone", "!=", "000000")->where("phone", "!=", "0")->where("phone", "!=", "00")->where("phone", "!=", "000");
                ...
                $vendeurs = Command::where("phone", "!=", null)->where("phone", "!=", "00000000")->where("phone", "!=", " 
99999999")->where("fee_id", "!=", null)->where("phone", "!=", "0000000")->where("phone", "!=", "000000")->where("phone", "!=", "0")->where("phone", "!=", "00")->where("phone", "!=", "000")->where("client_id", $client->id);
              }
