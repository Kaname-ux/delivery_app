...
<head>
    ...
    <title>Logistica - Vos courses en un click</title>
    <link rel="stylesheet" href="../assets/css/style.css">
    <meta name="viewport"
        content="width=device-width, initial-scale=1, minimum-scale=1, maximum-scale=1, viewport-fit=cover" />
    <meta name="description" content="e-commerce, courier, courses">
    <meta name="keywords" content="vente en ligne, livraison, courses, colis, Logistica" />
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="pt-3 text-center">
                        <img src="../assets/img/logo.png" alt="image" class="imaged w48  mb-1">
                    </div>
