...
<head>
    ...
    <title>Jibiat - Enregistrement</title>
    <link rel="stylesheet" href="../assets/css/style.css">
    <meta name="viewport"
        content="width=device-width, initial-scale=1, minimum-scale=1, maximum-scale=1, viewport-fit=cover" />
    <meta name="description" content="jibiaT Enregistrement">
                    ...
                    <div class="card-body">
                       ...
                       <div class="form-group basic">
                            ...
                            <div class="input-wrapper  @error('name') alert alert-outline-danger @enderror">
                                <label for="name" class="label">Nom ou nom commercial</label>
                                <input max="50" placeholder="Nom ou nom de boutique" id="name" type="text" class="form-control " name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
                       ...
                       <div class="form-group basic ">
                        ...
                        <div class="form-group basic">
                            ...
                            <div class="input-wrapper @error('goods_type') alert alert-outline-danger @enderror">
                                <label for="goods_type" class="label">Quels types d'articles vendez-vous?</label>
                                <input max="50" placeholder="Ex: Chaussures, cosmétique..." id="goods_type" type="text" class="form-control " name="goods_type" value="{{ old('goods_type') }}" required autocomplete="goods_type">
