                            ...
                            <label class="form-label">Filter par pays</label>
                              <select  id="fee-select" class="select2 form-control" multiple="multiple" data-placeholder="selectionner communes(s)"  name="countries[]">
                                 ...
                                 <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  <option value="<?php echo e($country[3]); ?>"><?php echo e($country[3]); ?></option>
                                 <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                 </select>
                                 <?php if ($errors->has('countries')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('countries'); ?>
                    ...
                    <div   class="modal-body">
                        <form method="post" enctype="multipart/form-data" :action="supplierAction" >
                            ...
                            <div class="form-group">
                                ...
                                <input required value="<?php echo e(old('name')); ?>" v-model="supplierName" name="name"  autocomplete="off" placeholder="Saisir le nom du fournisseur" class="form-control border border-primary" type="" >
...
if (isset($messageCache)) { $message = $messageCache; }
                            ...
                            <div class="form-group">
                                <label>Adresse</label>
                                <input value="<?php echo e(old('adress')); ?>" v-model="supplierAdress" name="adress" autocomplete="off" placeholder="Saisir adresse du fournisseur" class="form-control border border-primary" type="" >
...
if (isset($messageCache)) { $message = $messageCache; }
                             ...
                             <div class="form-group">
                                <label>Contact*</label>
                                <input v-model="supplierContact" required name="contact" value="<?php echo e(old('contact')); ?>" autocomplete="off" placeholder="Saisir contact du fournisseur" class="form-control border border-primary" type="number" >
...
if (isset($messageCache)) { $message = $messageCache; }
                             ...
                             <div class="form-group">
                                ...
                                <input v-model="supplierWhatsapp" name="whatsapp" minlength="10" maxlength="10" value="<?php echo e(old('whatsapp')); ?>"  autocomplete="off" placeholder="Saisir numero whatsapp du fournisseur" class="form-control border border-primary" type="number" >
...
if (isset($messageCache)) { $message = $messageCache; }
                            ...
                            <div class="form-group">
                                <label>Email</label>
                                <input v-model="supplierEmail" name="email" autocomplete="off" placeholder="Saisir adresse email du fournisseur" value="<?php echo e(old('email')); ?>" class="form-control border border-primary" type="email" >
  ...
  const app = Vue.createApp({
    data() {
        return {
            ...
            supplierName: "<?php echo e(old('name')); ?>",
            supplierCountry: "<?php echo e(old('country')); ?>",
            supplierAdress: "<?php echo e(old('adress')); ?>",
            supplierContact: "<?php echo e(old('contact')); ?>",
            supplierWhatsapp: "<?php echo e(old('whatsapp')); ?>",
            
            supplierTitle:"Ajouter un fournisseur",
            suppliers: <?php echo $sups; ?>,
            supplierEmail:"",
            supplierId: "<?php echo e(old('id')); ?>",
            errorTrigger:"",
...
<?php /**PATH /htdocs/clients/logistica/admin/resources/views/suppliers.blade.php ENDPATH**/ ?>