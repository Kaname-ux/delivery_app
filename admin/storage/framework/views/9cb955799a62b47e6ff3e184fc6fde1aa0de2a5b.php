      ...
      <div class="container-fluid">
       ...
       <?php if(session('status')): ?>
                        <div class="alert alert-success" role="alert">
                            ...
                            <?php if(session("offer")): ?>
                            <?php $added = session("offer"); ?>
                            <button data-toggle="modal" data-target="#cFeeModal" class='btn btn-primary ml-2' @click="getClientFees('<?php echo e($added->client_id); ?>','<?php echo e($added->client); ?>', '<?php echo e($added->description); ?>')">Defininir les tarif</button>
                            <?php endif; ?>
                        </div>
                    <?php endif; ?>
        <!-- /.row -->
                    ...
                    <tbody>
                     <?php $__currentLoopData = $offers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$offer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <tr >
                        ...
                        <button data-toggle="modal" data-target="#confirmModal" @click="deleteSubscription('<?php echo e($offer->id); ?>','<?php echo e(addslashes($offer->client)); ?>', '<?php echo e(addslashes($offer->description)); ?>')" class="btn btn-danger btn-sm mr-1" ><i   name="btn" value="Supprimer"  class="fas fa-trash"  ></i></button>
                          ...
                          <button type="button" data-toggle="modal" data-target="#cFeeModal" @click="getClientFees('<?php echo e($offer->client_id); ?>','<?php echo e(addslashes($offer->client)); ?>', '<?php echo e(addslashes($offer->description)); ?>')" class="btn btn-sm btn-primary mr-1" >Tarif</button>
                        ...
                        <td>
                          <?php if($offer->periods->count() > 0): ?>
                         <br>
                          <!-- <a class="mr-1" href="normalbill?">Généer</a>  -->
                          <button data-toggle="modal" data-target="#periodModal" @click="getPeriods(<?php echo e($offer->periods->toJson()); ?>)" class="btn btn-primary btn-sm">facturation</button>
                        ...
                        <td>#<?php echo e($offer->id); ?> - <?php echo e($offer->subscription_type); ?></td>
                        <td>
                        ...
                        <td>
                           <?php echo e($offer->duration); ?> mois
                        </td>
                        ...
                        <td>
                         ...
                         <!-- <td>
                          ...
                          <a href="#" data-toggle="modal" data-target="#billModal" @click="generateBill(<?php echo e($offer->id); ?>, '<?php echo e($offer->description); ?>', '<?php echo e(addslashes($offer->client)); ?>', '<?php echo e(date_create($offer->end)->format('Y-m-d')); ?>', '<?php echo e(date_create($offer->start)->format('Y-m-d')); ?>', 'Entre le <?php echo e(date_create($offer->start)->format('d-m-Y')); ?> et le <?php echo e(date_create($offer->end)->format('d-m-Y')); ?>' )">Générer</a>
                        </td> -->
...
if (isset($messageCache)) { $message = $messageCache; }
                           ...
                           <!-- 
                            <div class="form-group">
                                ...
                                <?php if ($errors->has('billing')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('billing'); ?>
                            <span class="invalid-feedback" role="alert">
                            <strong><?php echo e($message); ?></strong>
                                </span>
                              <?php unset($message);
                ...
                <div  class="modal-content">
                    ...
                    <div   class="modal-body">
                        ...
                        <div class="row mb-2">
                          ...
                          <div class="col" @click="changeClientFee('<?php echo e($cfee->id); ?>')"><button class="btn btn-primary btn-sm">Modifier</button></div>

                          <div class="col" @click="changeClientFee('<?php echo e($cfee->id); ?>')"><button>Modifier</button>
                          <span class="text-success" :id="'success'+'<?php echo e($cfee->id); ?>'"></span>
                          </div>
                        </div>
...
<?php /**PATH /var/www/html/jibiat/admin/resources/views/subscriptions.blade.php ENDPATH**/ ?>