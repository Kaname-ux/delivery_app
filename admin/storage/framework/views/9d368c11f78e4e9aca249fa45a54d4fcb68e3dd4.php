    ...
    -->
      ...
      <div class="sidebar-wrapper" id="sidebar-wrapper">
        <ul class="nav">
          ...
          <!-- <li class="<?php echo e('salesmen' == request()->path() ? 'active' : ''); ?>">
            <a href="/salesmen">
              <i class="now-ui-icons users_single-02"></i>
              <p>Commerciaux</p>
            </a>
          </li> -->
          <li  class="<?php echo e('livreur' == request()->path() ? 'active' : ''); ?>">
            <a href="/livreur">
          ...
          <li  class="<?php echo e('client' == request()->path() ? 'active' : ''); ?>">
            <a href="/client">
           ...
           <li  class="<?php echo e('payments' == request()->path() ? 'active' : ''); ?>">
            <a href="/payments">
         ...
         <li  class="<?php echo e('fee' == request()->path() ? 'active' : ''); ?>">
            <a href="/fee">
          ...
          <li  class="<?php echo e('charge' == request()->path() ? 'active' : ''); ?>">
            <a href="/charge">
         ...
         <li  class="<?php echo e('products' == request()->path() ? 'active' : ''); ?>">
            <a href="/products">
          ...
          <!-- <li class="<?php echo e('role-register' == request()->path() ? 'active' : ''); ?>">
           ...
           <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
                  <a class="<?php echo e('managers' == request()->path() ? 'active' : ''); ?>" class="dropdown-item" href="managers">Liste d'utilisateurs</a>
           ...
           <li class="<?php echo e('certifications' == request()->path() ? 'active' : ''); ?>">
           ...
           <li class="<?php echo e('rapport' == request()->path() ? 'active' : ''); ?>">
            <a href="/rapport">
...
</html><?php /**PATH /htdocs/clients/logistica/admin/resources/views/layouts/master.blade.php ENDPATH**/ ?>