<nav class="main-header navbar navbar-expand navbar-white navbar-light">
 ...
 <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="/motos" class="nav-link <?php echo e('motos' == request()->path() ? 'active' : ''); ?>">
              <i class="nav-icon fas fa-motorcycle"></i>
              <p>
                Véhicule
          ...
          <li class="nav-item">
           ...
           <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/offers" class="nav-link <?php echo e('offers' == request()->path() ? 'active' : ''); ?>">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Offres</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/subscriptions" class="nav-link <?php echo e('subscriptions' == request()->path() ? 'active' : ''); ?>">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Abonnés</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            <a href="/repportstart" class="nav-link <?php echo e('repportstart' == request()->path() ? 'active' : ''); ?>">
   ...
   <form id="logout-form" action="<?php echo e(route('logout')); ?>" method="POST" style="display: none;">
                    <?php echo csrf_field(); ?>
                </form><?php /**PATH /var/www/html/jibiat/admin/resources/views/includes/navbar.blade.php ENDPATH**/ ?>