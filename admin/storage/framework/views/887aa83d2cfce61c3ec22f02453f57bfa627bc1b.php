            ...
            <div class="card" style="min-height: 400px; max-height: 400px;">
              ...
              <div class="card-body table-responsive">
               <table class="table table-striped table-valign-middle">
                  ...
                  <?php $__currentLoopData = $cmds_by_city; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>  
                  <tr>
                    <td>
                     
                      <?php echo e($city->fee->destination); ?>
            ...
            <div class="card" style="min-height: 400px; max-height: 400px;">
              ...
              <div class="card-body table-responsive ">
                ...
                <table class="table table-striped table-valign-middle">
                  ...
                  <tbody>
                  <?php $__currentLoopData = $cmds_by_client; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $clt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <tr>
                    <td>
                      <?php if($clt->client): ?>
                      <?php echo e($clt->client->nom); ?>
   ...
   const app = Vue.createApp({
    data() {
        return {
            ...
            total_sum:<?php echo $commands->sum("livraison"); ?>,
            total_count:<?php echo $commands->count(); ?>,

            sum_done:<?php echo $commands->where("etat", "termine")->sum("livraison"); ?>,
            count_done:<?php echo $commands->where("etat", "termine")->count(); ?>,

            sum_undone:<?php echo $commands->whereIn("etat", ["en chemin", "recupere"])->sum("livraison"); ?>,
            count_undone:<?php echo $commands->whereIn("etat", ["en chemin", "recupere"])->count(); ?>,

            sum_encours:<?php echo $commands->where("etat", "encours")->sum("livraison"); ?>,
            count_encours:<?php echo $commands->where("etat", "encours")->count(); ?>,

            sum_delai:<?php echo $commands->whereIn("etat", ["en chemin", "recupere", "encours"])->where("date_delai", "!=", null)->where("commands.delivery_date", "<", "commands.date_delai")->sum("livraison"); ?>,
            count_delai:<?php echo $commands->whereIn("etat", ["en chemin", "recupere", "encours"])->where("date_delai", "!=", null)->where("commands.delivery_date", "<", "commands.date_delai")->count(); ?>,

            sum_cancel:<?php echo $commands->where("etat", "=", "annule")->sum("livraison"); ?>,
            count_cancel:<?php echo $commands->where("etat", "=", "annule")->count(); ?>,
...
<?php /**PATH /htdocs/clients/logistica/admin/resources/views/dashboard.blade.php ENDPATH**/ ?>