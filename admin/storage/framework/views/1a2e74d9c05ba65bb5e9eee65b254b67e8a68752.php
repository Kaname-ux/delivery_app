              ...
              <div class="card-body">
                 ...
                 <div class="row">
                  ...
                  <div class="form-group">
                    ...
                    <input name="name" class="form-control" required value="<?php echo e($company->name); ?>">
...
if (isset($messageCache)) { $message = $messageCache; }
                  ...
                  <div class="form-group">
                    ...
                    <input name="adresse" class="form-control" required value="<?php echo e($company->location); ?>">
                  ...
                  <div class="form-group">
                    ...
                    <input name="contact" class="form-control" required value="<?php echo e($company->contact); ?>">
...
if (isset($messageCache)) { $message = $messageCache; }
                  ...
                  <div class="form-group">
                    ...
                    <input name="mail" class="form-control" required value="<?php echo e($company->mail); ?>">
                   ...
                   <div class="form-group">
                    ...
                    <input name="wa" class="form-control" required value="<?php echo e($company->wa); ?>">
          ...
          <div class="col-4">
            ...
            <div v-if="text != null" class="col-4">
              ...
              <button @click="setTextToCurrentPos('TRACKING_CMD')" class="btn btn-secondary mr-1 mb-1 btn-sm  ">Lien de tracking</button>
               <button @click="setTextToCurrentPos('<?php echo e($company->name); ?>')" class="btn btn-secondary mr-1 mb-1 btn-sm  ">Nom de l'entreprise</button>


               <button @click="setTextToCurrentPos('<?php echo e($company->contact); ?>')" class="btn btn-secondary mr-1 mb-1 btn-sm  ">Contact l'entreprise</button>

               <button @click="setTextToCurrentPos('<?php echo e($company->location); ?>')" class="btn btn-secondary mr-1 mb-1 btn-sm  ">Adresse l'entreprise</button>

               

               <button @click="setTextToCurrentPos('https://wa.me/<?php echo e($company->wa); ?>')" class="btn btn-secondary mb-1 mr-1 btn-sm  ">Lien whatsapp l'entreprise</button>

               <button @click="setTextToCurrentPos('<?php echo e($company->mail); ?>')" class="btn btn-secondary mb-1 mr-1 btn-sm  ">Email l'entreprise</button>
...
<?php /**PATH /htdocs/clients/logistica/admin/resources/views/settings.blade.php ENDPATH**/ ?>