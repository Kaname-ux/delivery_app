              ...
              <div class="card-body">
                <div class="table-responsive">
                  ...
                  <form>
                    @csrf
                    <div class="form-group">
                     Livreur<input value="Livreur" class="form-control" type="checkbox" name="group[]">

                     Manager<input value="Manager" class="form-control" type="checkbox" name="group[]"> 

                     Vendeur<input value="Vendeur" class="form-control" type="checkbox" name="group[]">
                    </div>
                    <div class="form-group">
