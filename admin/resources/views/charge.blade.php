                                ...
                                <div class="form-group basic">
                                    <div class="input-wrapper">
                                        ...
                                        <form  autocomplete="off"  action='?' >
                                         ...
                                         <input hidden value='{{date("Y-m-d",strtotime("first day of january this year"))}}'    class="form-control "  name="start">
                                         <input hidden value='{{date("Y-m-d",strtotime("last day of december this year"))}}'    class="form-control "  name="end">
                                         ...
                                         <input hidden value='{{date("Y-m-d",strtotime("first day of january last year"))}}'    class="form-control "  name="start">
                                         <input hidden value='{{date("Y-m-d",strtotime("last day of december last year"))}}'    class="form-control "  name="end">
                  ...
                  <thead class=" text-primary">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <form  onsubmit="return confirm('Souhaitez vous vraiment supprimer?');"   method="POST" action="/charge-delete/{{$charge->id}}">
                            <a href="/chargeedit/{{$charge->id}}" ><i class="fas fa-edit"></i></a>
                   ...
                   function myFunction{{$charge->id}}() {
                    confirm("Confirmer!");
                        ...
                        <td>
                          @if($charge->periode == 52)
                          Hebdomadiare
                          @endif

                          @if($charge->periode == 12)
                          Mensuel
                          @endif
