                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          src="{{Storage::disk('s3')->url($certification->photo_ref)}}" 
                        ...
                        <td>
                          ...
                          <img width="200px" height="200px"
                          src="{{Storage::disk('s3')->url($certification->piece_ref)}}" 
                            class="image-block imaged w48 big">
                        ...
                        <td>
                          <button data-liv="{{$certification->livreur_id}}" value="{{$certification->user_id}}" data-name="{{$certification->name}}" class="btn btn-success accept" data-photo="{{Storage::disk('s3')->url($certification->photo_ref)}}" data-p_photo="{{Storage::disk('s3')->url($certification->piece_ref)}}" data-phone='{{$certification->phone}}'
                            data-wphone='{{$certification->wphone}}' data-cert_id="{{$certification->id}}">Accepter</button>
                          <button value="{{$certification->id}}" class="btn btn-danger refused">Refuser</button>
                        </td>
