                   ...
                   <thead class=" text-primary">
                    ...
                    <tbody>
                      ...
                      <tr >
                        ...
                        <td><a href="useractions?id={{$client->user_id}}&start={{$start}}&end={{$end}}">{{$client->nom}}</a></td>
                        <td>{{$userobj($client->client_type, $start, $end)}}</td>


                        <td>
                          {{$client->command->whereBetween("delivery_date", [$start, $end])->count()}}<br>
                          <div class="progress">
                          @if($client->command->whereBetween("delivery_date", [$start, $end])->count() > 0)
       <div class="progress-bar 
       @if(round(($client->command->whereBetween("delivery_date", [$start, $end])->count()/($userobj($client->client_type, $start, $end)))*100) < 50) bg-danger @endif

       
       @if(round(($client->command->whereBetween("delivery_date", [$start, $end])->count()/($userobj($client->client_type, $start, $end)))*100) >= 100) bg-success @endif


       " role="progressbar" style="width: {{round(($client->command->whereBetween("delivery_date", [$start, $end])->count()/($userobj($client->client_type, $start, $end)))*100)}}%;" aria-valuenow="{{round(($client->command->whereBetween("delivery_date", [$start, $end])->count()/($userobj($client->client_type, $start, $end)))*100)}}" aria-valuemin="0" aria-valuemax="100">{{round(($client->command->whereBetween("delivery_date", [$start, $end])->count()/($userobj($client->client_type, $start, $end)))*100)}}%</div>
       @endif
      </div>
                        ...
                        <td>
                          {{$client->command->whereBetween("delivery_date", [$start, $end])->where("etat", "termine")->count()}}<br>




                           <div class="progress">
                          @if($client->command->whereBetween("delivery_date", [$start, $end])->where("etat", "termine")->count() > 0)
       <div class="progress-bar 
       @if(round(($client->command->whereBetween("delivery_date", [$start, $end])->where("etat", "termine")->count()/($userobj($client->client_type, $start, $end)))*100) < 50) bg-danger @endif

       
       @if(round(($client->command->whereBetween("delivery_date", [$start, $end])->where("etat", "termine")->count()/($userobj($client->client_type, $start, $end)))*100) >= 100) bg-success @endif


       " role="progressbar" style="width: {{round(($client->command->whereBetween("delivery_date", [$start, $end])->where("etat", "termine")->count()/($userobj($client->client_type, $start, $end)))*100)}}%;" aria-valuenow="{{round(($client->command->whereBetween("delivery_date", [$start, $end])->where("etat", "termine")->count()/($userobj($client->client_type, $start, $end)))*100)}}" aria-valuemin="0" aria-valuemax="100">{{round(($client->command->whereBetween("delivery_date", [$start, $end])->where("etat", "termine")->count()/($userobj($client->client_type, $start, $end)))*100)}}%</div>
       @endif
      </div>
...
{{$client->command->whereBetween("delivery_date", [$start, $end])->where("etat", "annule")->count()}}<br>




                           <div class="progress">
                          @if($client->command->whereBetween("delivery_date", [$start, $end])->where("etat", "annule")->count() > 0)
       <div class="progress-bar 
       @if(round(($client->command->whereBetween("delivery_date", [$start, $end])->where("etat", "annule")->count()/($userobj($client->client_type, $start, $end)))*100) < 50) bg-danger @endif

       
       @if(round(($client->command->whereBetween("delivery_date", [$start, $end])->where("etat", "annule")->count()/($userobj($client->client_type, $start, $end)))*100) >= 100) bg-success @endif


       " role="progressbar" style="width: {{round(($client->command->whereBetween("delivery_date", [$start, $end])->where("etat", "annule")->count()/($userobj($client->client_type, $start, $end)))*100)}}%;" aria-valuenow="{{round(($client->command->whereBetween("delivery_date", [$start, $end])->where("etat", "annule")->count()/($userobj($client->client_type, $start, $end)))*100)}}" aria-valuemin="0" aria-valuemax="100">{{round(($client->command->whereBetween("delivery_date", [$start, $end])->where("etat", "annule")->count()/($userobj($client->client_type, $start, $end)))*100)}}%</div>
       @endif
      </div>
