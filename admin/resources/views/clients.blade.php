                    ...
                    <div   class="modal-body">
                        <form method="post" enctype="multipart/form-data" :action="costumerAction" >
                            ...
                            <div class="form-group">
                                ...
                                <input value="{{old('name')}}" v-model="costumerName" name="name"  autocomplete="off" placeholder="Saisir le nom du client" class="form-control border border-primary" type="" >
                          ...
                          <select  v-model="costumerLocality"  required  class="form-control" name="locality">
                           ...
                           @endforeach
                            ...
                            <div class="form-group">
                                <label>Adresse</label>
                                <input value="{{old('adress')}}" v-model="costumerAdress" name="adress" autocomplete="off" placeholder="Saisir adresse du client" class="form-control border border-primary" type="" >
                                @error('adress')
                            <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                                </span>
                             ...
                             <div class="form-group">
                                <label>Contact*</label>
                                <input v-model="costumerContact" required name="contact" value="{{old('contact')}}" autocomplete="off" placeholder="Saisir contact du client" class="form-control border border-primary" type="number" >
                            ...
                            <strong>{{ $message }}</strong>
                             ...
                             <div class="form-group">
                                ...
                                <input v-model="costumerWhatsapp" name="whatsapp" value="{{old('whatsapp')}}"  autocomplete="off" placeholder="Saisir numero whatsapp du client" class="form-control border border-primary" type="number" >
                            ...
                            <div class="form-group">
                                <label>Email</label>
                                <input v-model="costumerEmail" name="email" autocomplete="off" placeholder="Saisir adresse email du client" value="{{old('email')}}" class="form-control border border-primary" type="email" >
