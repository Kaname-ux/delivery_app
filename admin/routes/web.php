...
Route::post('add-department', 'Admin\DashboardController@adddepartment');
Route::post('delete-department', 'Admin\DashboardController@deletedepartment');
...
Route::post('/clientaccount', 'Admin\DashboardController@clientaccount');
...
Route::get('/motos','MotosController@motos');
Route::post('/addmoto', 'MotosController@create');
Route::post('/editmoto', 'MotosController@edit');
Route::post('/deletemoto', 'MotosController@deletemoto');

Route::post('/addspend', 'MotosController@addspend');
Route::post('/editspend', 'MotosController@editspend');
Route::post('/deletespend', 'MotosController@deletespend');

Route::post('/affectmoto', 'MotosController@affectmoto');
...
Route::post('/getcancelreasons', 'Admin\DashboardController@getcancelreasons');
Route::get('/rapports', 'Admin\DashboardController@rapports');

Route::get('/repportstart', 'Admin\DashboardController@repportstart');
...
Route::get('/subscriptions','OffersController@subscriptions');
Route::post('/getfees','OffersController@getfees');
Route::post('/createsubscription','OffersController@createsubscription');
Route::post('/changecfee','OffersController@changecfee');
Route::post('/getsubs','OffersController@getsubs');
Route::get('/bill','OffersController@bill');
Route::get('/billing','OffersController@billing');
Route::post('/addbillpay','OffersController@addbillpay');
Route::post('/editbillpay','OffersController@editbillpay');
Route::post('/deletebillpay','OffersController@deletebillpay');

Route::post('/issuedate','OffersController@issuedate');
Route::post('/deletesubscription','OffersController@deletesubscription');
Route::post('/getstatus','OffersController@getstatus');
Route::get('/bulkbill','OffersController@bulkbill');

Route::post('/getsubscriptions','OffersController@getsubscriptions');
 }); 
