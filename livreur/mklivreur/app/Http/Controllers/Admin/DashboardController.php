  ...
  {$retour .= "<div class='col'>
   ...
   $livreur_info = "";
    ...
    if($smscount > 0){
      ...
      $codifieds = array("NUMERO_CMD"=>$model->id, "TOTAL_CMD"=>$model->montant+$model->livraison-$model->remise, "TRACKING_CMD"=>'https://commercial.meta-kiwi.net/tracking/'.$model->id, "LIVREUR_CMD"=>$livreur_info);
  ...
  $day = "Aujourd'hui";
   ...
   $moov = array('01', '02', '03', '41', '42', '43', '51', '52', '53', '61', '62', '63', '71', '72', '73', '81', '82', '83', '97');
      ...
      $commands = Command::orderBy('etat', "asc")
       ...
       $retours = Command::whereIn('etat', ["recupere", "en chemin", "annule"])
                  ->orderBy('delivery_date', "desc")
                  ->where('livreur_id', $livreur_id)
                  ->whereDate('delivery_date', ">", $ref_date)
                 ->get();
