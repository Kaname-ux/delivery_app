  ...
  public function certification()
{
  ...
  $current = Certification::where('livreur_id',$livreur->id)->where("status", "pendind")->orWhere("status", "refused")->latest()->first();
 ...
 public function send(Request $request)
{
  ...
  $request->validate([
        ...
        'piece_photo' => 'required|mimes:jpeg,png|max:4096',
