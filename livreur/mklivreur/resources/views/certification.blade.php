       ...
       <div class="section mt-2 text-center">
        ...
        <div class="section mb-5 p-2">
            ...
            <strong> Demande effectuée le:
                ...
                {{$current->created_at->format("d-m-Y")}}
                </strong>
                </div>
             </div>   
            @else
                    ...
                    <div class="form-group">
                       ...
                       <div class="form-group basic">
                            ...
                            <div class="input-wrapper  @error('name') alert alert-outline-danger @enderror">
                                ...
                                @if(old('name'))
                                value="{{ old('name') }}" @else value="{{$livreur->nom}}" @endif required autocomplete="name" 
                                autofocus>
                        ...
                        <div class="form-group basic">
                         ...
                         <div class="form-group basic">
                            ...
                            <div class="input-wrapper @error('phone') alert alert-outline-danger @enderror">
                                ...
                                <input maxlength="10" placeholder="Ex: 0700000000" id="phone" type="number" class="form-control " name="wphone" value="{{ old('wphone') }}" required autocomplete="phone" autofocus>
