...
<body>
    ...
    <div id="appCapsule">
        ...
        <div class="section mb-5 p-2">
            <form class="send" method="POST" action="<?php echo e(route('register')); ?>">
                <?php echo csrf_field(); ?>
...
if (isset($messageCache)) { $message = $messageCache; }
                        ...
                        <?php 
                          $communes = array("Adjamé", "Cocody", "Attécoubé", "Bingerville", "Agnama", "Koumassi", "Plateau", "Treichville", "Marcory", "Port-Bouet", "Grand Bassam", "Songon", "Abobo", "Yopougon", "N'dotre","KM17", "Abobodoumé", "Azito" );
...
if (isset($messageCache)) { $message = $messageCache; }
                                ...
                                <input value="<?php echo e(old('password')); ?>" min="8" max="20" name="password" type="password" class="form-control " name="password" required autocomplete="new-password"placeholder="8 caratères minimum">
                                <i class="clear-input">
                                    <ion-icon name="close-circle"></ion-icon>
                                </i>
...
if (isset($messageCache)) { $message = $messageCache; }
                                ...
                                <input value="<?php echo e(old('password_confirmation')); ?>" type="password" class="form-control "  required name="password_confirmation"  id="password2" placeholder="Confirmer mot de passe">
                                <i class="clear-input">
                                    <ion-icon name="close-circle"></ion-icon>
                                </i>
...
<?php /**PATH /htdocs/clients/logistica/livreur/resources/views/auth/register.blade.php ENDPATH**/ ?>