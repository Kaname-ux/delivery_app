    ...
    <div class="appHeader">
        ...
        <div class="right">
            <a href="livraisons" class="headerButton">
                ...
                @if($livreur->command->where('delivery_date', today())->where('etat', 'encours')->count()>0)
                <span class="badge badge-danger">
                    
                    {{$livreur->command->where('delivery_date', today())->where('etat', 'encours')->count()}}
                ...
                <div class="card-body">
                        ...
                        <div class="form-group basic">
                            <div class="input-wrapper">
                                ...
                                <input readonly name="name" value="{{$livreur->nom}}" type="text" class="form-control" id="userid1" placeholder="Nom et premon">
                                <i class="clear-input">
                        ...
                        <div class="form-group basic">
                            <div class="input-wrapper">
                                <label class="label" for="select4">Ville / Commune</label>
                                 <input readonly  value="{{$livreur->city}}" type="text" class="form-control" id="userid1" >
                            </div>
                        </div>
                        ...
                        <div class="form-group basic">
                            <div class="input-wrapper">
                                ...
                                <input readonly name="adresse" value="{{$livreur->adresse}}" type="text" class="form-control" id="userid1" >
                                <i class="clear-input">
                                    <ion-icon name="close-circle"></ion-icon>
                                </i>
                            </div>
